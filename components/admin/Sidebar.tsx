...
const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/coupons', label: 'কুপন', enabled: true, icon: <><path d="M20.59 13.41 11 3H4v7l9.59 9.59a2 2 0 0 0 2.82 0l4.18-4.18a2 2 0 0 0 0-2.82Z" /><circle cx="7.5" cy="7.5" r="1.5" /></> },
